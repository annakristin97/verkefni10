(function () {
	...
	*/
	...
	var API_KEY = 'J9nUuqpvZkldg9UDeaf806BsLJWTdS4BBHb3KBE6'; // Slóð að sækja myndir frá. Dæmi um heila slóð https://api.nasa.gov/planetary/apod?api_key=DEMO_KEY&date=2019-11-10
	...
	function getRandomImage() {
	  var date, result, _ref, imageUrl, text, title;
	    ...
	    while (1) {
	      switch (_context.prev = _context.next) {
	        case 0:
	          date = getRandomDate();
	          _context.next = 3;
	          return regeneratorRuntime.awrap(fetch("".concat(URL, "?api_key=").concat(API_KEY, "&date=").concat(date)));
	...
	function save(type, imageUrl, text, title) {
	  var favorites = load();
	...
	function getNewImage() {
	  return regeneratorRuntime.async(function getNewImage$(_context) {
	    while (1) {
	      switch (_context.prev = _context.next) {
	        case 0:
	          _context.next = 2;
	          return regeneratorRuntime.awrap(getRandomImage());
